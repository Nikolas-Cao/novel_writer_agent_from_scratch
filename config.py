...
# ----- 章节视频生成（云端 API 优先）-----
VIDEO_PROVIDER = os.getenv("VIDEO_PROVIDER", "generic_http")
VIDEO_API_BASE_URL = os.getenv("VIDEO_API_BASE_URL", "").strip()
VIDEO_API_KEY = os.getenv("VIDEO_API_KEY", "").strip()
VIDEO_MODEL = os.getenv("VIDEO_MODEL", "video-gen-v1")
VIDEO_TIMEOUT_S = float(os.getenv("VIDEO_TIMEOUT_S", "180"))
VIDEO_MAX_RETRIES = int(os.getenv("VIDEO_MAX_RETRIES", "2"))
VIDEO_TARGET_FPS = int(os.getenv("VIDEO_TARGET_FPS", "24"))
VIDEO_TARGET_RESOLUTION = os.getenv("VIDEO_TARGET_RESOLUTION", "1920x1080")
VIDEO_DEFAULT_SCENE_SECONDS = int(os.getenv("VIDEO_DEFAULT_SCENE_SECONDS", "40"))
VIDEO_MAX_BUDGET = float(os.getenv("VIDEO_MAX_BUDGET", "20"))

TTS_PROVIDER = os.getenv("TTS_PROVIDER", "generic_http")
TTS_API_BASE_URL = os.getenv("TTS_API_BASE_URL", "").strip()
TTS_API_KEY = os.getenv("TTS_API_KEY", "").strip()
TTS_MODEL = os.getenv("TTS_MODEL", "tts-v1")
TTS_TIMEOUT_S = float(os.getenv("TTS_TIMEOUT_S", "120"))
TTS_MAX_RETRIES = int(os.getenv("TTS_MAX_RETRIES", "2"))
TTS_DEFAULT_NARRATION_SPEED = float(os.getenv("TTS_DEFAULT_NARRATION_SPEED", "1.0"))
